...
<style>
    ...
    /* Submit btn */
    .btn-donate { width: 100%; padding: 13px; border-radius: 10px; background: var(--sky); color: var(--dark); font-size: 15px; font-weight: 800; border: none; cursor: pointer; transition: all 0.2s; font-family: inherit; box-shadow: 0 4px 20px var(--sky-glow); display: flex; align-items: center; justify-content: center; gap: 8px; margin-top: 8px; }
...
<div class="topbar">
    <div class="topbar-left">
        ...
        <p class="page-sub">Simulasikan donasi masuk ke akun kamu</p>
    </div>
</div>
...
<div class="page-content">
    ...
    <div class="success-banner">
        ...
        <div>
            <div class="success-title">Donasi Berhasil Dikirim! 🎉</div>
            <div class="success-sub">
                <strong style="color:white">{{ session('donate_nama') }}</strong>
                mengirim <strong style="color:var(--sky)">{{ session('donate_amount') }}</strong>
                — otomatis masuk ke riwayat transaksi kamu
            </div>
        </div>
    </div>
    @endif
            ...
            <div class="donate-form-card">
                ...
                <div class="form-body">
                    ...
                    <div class="link-info">
                        ...
                        <div>
                            <div class="link-info-text">Link donasi publik kamu untuk dibagikan ke penonton:</div>
                    ...
                    <form method="POST" action="{{ route('donate.send') }}" id="donateForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="nominal-grid">
                                @foreach([5000,10000,20000,50000,100000,500000] as $nom)
                            ...
                            <div class="amount-wrap">
                                ...
                                <input type="number" name="jumlah" id="jumlahInput"
                                    ...
                                    placeholder="0" min="1000" max="10000000"
                                    value="{{ old('jumlah') }}" required>
                            </div>
                            <p style="font-size:11px; color:var(--muted); margin-top:6px">
                                <i class="bi bi-info-circle"></i> Minimal Rp 1.000 · Maksimal Rp 10.000.000
                            </p>
                        ...
                        <div class="form-group" style="margin-bottom:0">
                            ...
                            <textarea name="pesan" id="pesanInput"
                                ...
                                maxlength="300"
                                style="min-height:100px">{{ old('pesan') }}</textarea>
                        ...
                        <button type="submit" class="btn-donate" id="submitBtn">
                            <i class="bi bi-send-fill"></i> Kirim Donasi
                        </button>
                    </form>
                </div>
            </div>
        ...
        <div>
            <div class="riwayat-card">
                <div class="card-header">
                    <div>
                        <p class="card-title">Riwayat Donasi Masuk</p>
                ...
                <div class="card-body">
                    ...
                    <div class="empty-state">
                        ...
                        <p style="font-size:12px; margin-top:6px">Bagikan link donasi kamu ke penonton!</p>
                    </div>
                    @endforelse
                </div>
            </div>
...
pesanInput?.addEventListener('input', function() {
    ...
    const max = 300;
    charCounter.textContent = len + ' / ' + max + ' karakter';
    charCounter.className = 'char-counter';
    if (len >= max) charCounter.classList.add('danger');
    else if (len >= max * 0.8) charCounter.classList.add('warn');
});

// Init counter jika ada old value
if (pesanInput && pesanInput.value.length > 0) {
