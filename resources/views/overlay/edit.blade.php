            ...
            <div class="section-card">
                ...
                <div class="section-body">
                    <p style="font-size:13px; color:var(--muted2); margin-bottom:14px">
                        Tambahkan sebagai <strong style="color:var(--text)">Browser Source</strong> di OBS atau software streaming kamu.
                    </p>
                    <div class="url-box">
                        <span id="obsUrl">{{ url('/overlay-source/' . auth()->user()->username) }}</span>
